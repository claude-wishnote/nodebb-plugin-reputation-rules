...
// 全局分数记录的键
const scoreRecordKey = 'reputation-rules:users:score:records';
// 用户分数记录的键（函数）
const userScoreKey = uid => `reputation-rules:user:${uid}:score:records`;
// 用户总分数的键（函数）
const userTotalScoreKey = uid => `reputation-rules:user:${uid}:total:score`;
